...
<<<<<<< HEAD
source("helper.R")
two_column("Routine and manual jobs are rapidly being automated using newly developed computer, robotic, and machine learning technologies. This trend will accelerate over time.","./img/index/01_index.png")
=======
source("helper2.R")
...
>>>>>>> 923084809567deb2e73d8b1b67bb5637be957afc
```
...
<<<<<<< HEAD
source("helper.R")
two_column("At the same time there is strong and growing demand for people with skills in data processing, analysis, and reporting.","./img/index/02_index.png",iside="right")
=======
source("helper2.R")
...
<<<<<<< HEAD
source("helper.R")
two_column("But people who are currently unemployed or employed in manual or other low tech jobs face barriers to transitioning to data science jobs. The high cost of computing, education, and the centralization of jobs in high-cost metro areas prevent career transitions.","./img/index/04_index.png",iside="left")
=======
source("helper2.R")
...
<<<<<<< HEAD
source("helper.R")
two_column("We have developed a curriculum that is fully cloud based to allow students to do data science with cheap laptops like Chromebooks.","./img/index/chromebook.png",iside="right")
=======
source("helper2.R")
